...
def main() -> None:
    ...
    ap.add_argument("--method", choices=["static", "heuristic", "jev", "heur3", "jev3"], required=True)
    ...
    if a.method in ("jev3", "heur3"):
        ...
        if a.method == "jev3":
            ...
            judge = C3.Heur3()
        ctl3 = C3.Controller3(judge, prof, bounds(prof["algorithm"]), a.interval)
